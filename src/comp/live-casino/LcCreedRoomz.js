...
function LcTembo (){
    ...
    const [ocddragontiger, setocddragontiger] = useState('');
    const onClickocddragontiger = ()=>{
        setocdallcasino(false);
        setocdroluette(false);  
        setocdteenpati(false);  
        setocdpoker(false); 
        setocdbaccarat(false);
        setocddragontiger(true);
    };
    ...
    return(
        ...
        <div class="lcourcasino">
            <div class="lcourcasino-div1">
                <div onClick={onClickocdallcasino} class={ocdallcasino? 'lcourcasino-div1a-onclick' : 'lcourcasino-div1a'}>Roulette</div>
                <div onClick={onClickocdroluette} class={ocdroluette? 'lcourcasino-div1a-onclick' : 'lcourcasino-div1a'}>Blackjack</div>
                <div onClick={onClickocdteenpati} class={ocdteenpati? 'lcourcasino-div1a-onclick' : 'lcourcasino-div1a'}>Baccarat</div>
                <div onClick={onClickocdpoker} class={ocdpoker? 'lcourcasino-div1a-onclick' : 'lcourcasino-div1a'}>Poker</div>
                <div onClick={onClickocdbaccarat} class={ocdbaccarat? 'lcourcasino-div1a-onclick' : 'lcourcasino-div1a'}>Keno</div>
                <div onClick={onClickocddragontiger} class={ocddragontiger? 'lcourcasino-div1a-onclick' : 'lcourcasino-div1a'}>Others</div>
