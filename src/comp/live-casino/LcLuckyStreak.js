    ...
    return(
        ...
        <div class="lcourcasino">
            <div class="lcourcasino-div1">
                <div onClick={onClickolsallcasino} class={olsallcasino? 'lcourcasino-div1a-onclick' : 'lcourcasino-div1a'}>Baccarat</div>
                <div onClick={onClickolsroluette} class={olsroluette? 'lcourcasino-div1a-onclick' : 'lcourcasino-div1a'}>Roulette</div>
