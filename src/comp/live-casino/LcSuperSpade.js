    ...
    return(
        ...
        <div class="lcourcasino">
            <div class="lcourcasino-div1">
                <div onClick={onClickocdallcasino} class={ocdallcasino? 'lcourcasino-div1a-onclick' : 'lcourcasino-div1a'}>Andar Bahar</div>
                <div onClick={onClickocdroluette} class={ocdroluette? 'lcourcasino-div1a-onclick' : 'lcourcasino-div1a'}>Baccarat</div>
                <div onClick={onClickocdteenpati} class={ocdteenpati? 'lcourcasino-div1a-onclick' : 'lcourcasino-div1a'}>Roulette</div>
                <div onClick={onClickocdpoker} class={ocdpoker? 'lcourcasino-div1a-onclick' : 'lcourcasino-div1a'}>Others</div>
