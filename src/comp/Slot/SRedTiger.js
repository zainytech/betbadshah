    ...
    return(
        ...
        <div class="lcourcasino">
            <div class="lcourcasino-div1">
                <div onClick={onClickovallcasino} class={ovallcasino? 'lcourcasino-div1a-onclick' : 'lcourcasino-div1a'}>New Slots</div>
                <div onClick={onClickovroluette} class={ovroluette? 'lcourcasino-div1a-onclick' : 'lcourcasino-div1a'}>3 REEL</div>
                <div onClick={onClickovteenpati} class={ovteenpati? 'lcourcasino-div1a-onclick' : 'lcourcasino-div1a'}>4 REEL</div>
                <div onClick={onClickovpoker} class={ovpoker? 'lcourcasino-div1a-onclick' : 'lcourcasino-div1a'}>5 REEL</div>
                <div onClick={onClickovbaccarat} class={ovbaccarat? 'lcourcasino-div1a-onclick' : 'lcourcasino-div1a'}>6 REEL</div>
                <div onClick={onClickovdragontiger} class={ovdragontiger? 'lcourcasino-div1a-onclick' : 'lcourcasino-div1a'}>7 REEL</div>
