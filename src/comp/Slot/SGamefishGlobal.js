    ...
    return(
        ...
        <div class="lcourcasino">
            <div class="lcourcasino-div1">
                <div onClick={onClickoobotaallcasino} class={oobotaallcasino? 'lcourcasino-div1a-onclick' : 'lcourcasino-div1a'}>5 REEL</div>
