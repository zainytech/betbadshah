    ...
    return(
        ...
        <div class="lcourcasino">
            <div class="lcourcasino-div1">
                <div onClick={onClickocdallcasino} class={ocdallcasino? 'lcourcasino-div1a-onclick' : 'lcourcasino-div1a'}>3 REEL</div>
                <div onClick={onClickocdroluette} class={ocdroluette? 'lcourcasino-div1a-onclick' : 'lcourcasino-div1a'}>5 REEL</div>
                <div onClick={onClickocdteenpati} class={ocdteenpati? 'lcourcasino-div1a-onclick' : 'lcourcasino-div1a'}>6 REEL</div>
                <div onClick={onClickocdpoker} class={ocdpoker? 'lcourcasino-div1a-onclick' : 'lcourcasino-div1a'}>7 REEL</div>
