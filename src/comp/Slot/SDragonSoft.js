    ...
    return(
        ...
        <div class="lcourcasino">
            <div class="lcourcasino-div1">
                <div onClick={onClickovgallcasino} class={ovgallcasino? 'lcourcasino-div1a-onclick' : 'lcourcasino-div1a'}>3REEL</div>
                <div onClick={onClickovgroluette} class={ovgroluette? 'lcourcasino-div1a-onclick' : 'lcourcasino-div1a'}>4 REEL</div>
                <div onClick={onClickovgteenpati} class={ovgteenpati? 'lcourcasino-div1a-onclick' : 'lcourcasino-div1a'}>5 REEL</div>
                <div onClick={onClickovgpoker} class={ovgpoker? 'lcourcasino-div1a-onclick' : 'lcourcasino-div1a'}>6 REEL</div>
